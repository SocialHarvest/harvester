...
func (s *FacebookSuite) SetUpSuite(c *C) {
	...
	s.config.Services.Facebook.AppId = "113757085390653"
	s.config.Services.Facebook.AppSecret = "HVrouy9xXhIGmgW79HPzZTYgO8g"
	s.config.Services.Facebook.AppToken = "113757085390653|HVrouy9xXhIGmgW79HPzZTYgO8g"
